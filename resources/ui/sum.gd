##
# Copyright (c) 2014 Cristian Porras (porrascristian@gmail.com), Pablo Osorio
...
func setResult():
	...
	fakeResult2 = round (rand_range(20,198));
...
func _on_result_pressed():
		...
		get_node("/root/game").goodResultAction("sum");

func _on_fakeResult_pressed():
		print("Fake Result");
		get_node("/root/game").fakeResultAction("sum");
